...
m_inf = my_cell.m_inf(V)
tau_m = 1.0 / (my_cell.alpha_m(V) + my_cell.beta_m(V))
...
f5 = plt.figure(5)
plt.subplot(121)
plt.plot(V*1000, m_inf)
plt.title(r'$m_{\infty}$')
plt.xlabel('V [mV]')
plt.ylabel(r'$m_{\infty}$')
plt.subplot(122)
plt.plot(V*1000, tau_m*1000)
plt.title(r'$\tau_m$')
plt.xlabel('V [mV]')
...
f6 = plt.figure(6)
plt.subplot(121)
plt.plot(Ca*1e6, q_inf)
plt.title(r'$q_{\infty}$')
plt.xlabel('[Ca2+] [nM]')
plt.ylabel(r'$q_{\infty}$')
plt.subplot(122)
plt.plot(Ca*1e6, tau_q*1000)
plt.title(r'$\tau_q$')
plt.xlabel('[Ca2+] [nM]')
